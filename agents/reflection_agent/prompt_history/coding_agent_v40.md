...
- Explicitly verify before output: failed run: pm_agent error: PM output failed validation — acceptance_criteria must be a list of 2–6 non-empty, non-duplicate strings. Got: None
