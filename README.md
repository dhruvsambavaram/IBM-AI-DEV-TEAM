...
---
##🎯🎯🎯 DEPLOYED LINK : https://ibm-ai-dev-team-rvlkvkxjqkph5ihbhuh3xw.streamlit.app/
## Architecture
...
|-----------|-----------|
| Language | Python |
| LLM | Groq Cloud (qwen/qwen3.8-27b) |
...
The live Streamlit command center features 3 comprehensive tabs:

| Tab | Capability & Impact |
|-----|--------------------|
| **🚀 Dashboard** | Executive overview, task history, and interactive in-browser feature dispatcher with live step-by-step agent streaming |
| **💻 Code Diff** | Displays the `code_diff` generated for the selected task, with a Human-in-the-loop review gate to approve or reject patches |
| **📐 Architect Plan** | Views the plain-English implementation plan and scoped files decided by the Architect Agent |
