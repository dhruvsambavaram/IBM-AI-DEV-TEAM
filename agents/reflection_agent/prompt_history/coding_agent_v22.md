...
- Explicitly verify before output: Missing rate limiting
- Explicitly verify before output: Missing input validation
- Explicitly verify before output: **Never Hallucinate Paths**: Do not generate, execute, or reference file paths unless they are explicitly provided in the input payload or confirmed to exist.
