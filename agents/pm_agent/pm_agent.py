...
def _call_watsonx(prompt: str, system_prompt: str | None = None, max_tokens: int = 600) -> str:
    """
    ...
    return call_bob_chat(prompt, system_prompt=system_prompt, max_tokens=max_tokens)
...
def call_bob_pm(feature_request: str, previous_error: str = "") -> dict:
    ...
    raw = _call_watsonx(user_message, system_prompt=system_prompt, max_tokens=600)
